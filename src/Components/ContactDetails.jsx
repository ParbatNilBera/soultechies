    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="text-center mb-16">
          ...
          >
            Tell us about your vision and we’ll make it real
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            {[
              { icon: Mail, label: "Email", value: "soulte3h@gmail.com" },
              { icon: Phone, label: "Phone", value: "+91 6289 549 477" },
              ...
              >
                <item.icon size={24} style={{ color: PRIMARY }} />
                <h3
                ...
                <p style={{ color: "var(--contact-text)" }}>{item.value}</p>
              </div>
            ))}
          </div>
          ...
          {/* FORM */}
          <div
            className="lg:col-span-2 p-10 rounded-3xl backdrop-blur-md"
            style={{
              background: "var(--contact-card-bg)",
              border: "1px solid var(--contact-border)",
            }}
          >
            ...
            <textarea
              ...
              className="w-full mt-6 px-4 py-3 rounded-xl border focus:outline-none"
              style={{
                background: "var(--contact-input-bg)",
                borderColor: "var(--contact-border)",
                color: "var(--contact-title)",
            ...
            <motion.button
              ...
              style={{ background: PRIMARY, color: PRIMARY_TEXT }}
            >
